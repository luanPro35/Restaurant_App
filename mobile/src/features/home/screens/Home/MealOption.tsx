...
// Mock data using the same images for demonstration purposes
// In a real app, these would be relevant images or URLs
  ...
  return (
    <View className="py-4">
      <View className="px-4 mb-4">
        <Text className="text-gray-800 text-xl font-bold">Gợi ý theo bữa</Text>
      </View>
