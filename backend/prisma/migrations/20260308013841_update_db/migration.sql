...
CREATE TABLE `products` (
    ...
    `unit` VARCHAR(191) NOT NULL DEFAULT 'đĩa',
...
CREATE TABLE `tables` (
    ...
    `location` VARCHAR(191) NOT NULL DEFAULT 'Main Hall',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `orders` (
    ...
    `status` ENUM('PENDING', 'CONFIRMED', 'COOKING', 'SERVED', 'COMPLETED', 'CANCELLED') NOT NULL DEFAULT 'PENDING',
